...
function Example() {
  return (
    <div className="font-sans antialiased h-screen flex">
      ...
      <div className="bg-indigo-900 text-purple-200 flex-none p-4 hidden md:block">
        <div className="cursor-pointer mb-4">
          <div className="bg-white h-12 w-12 flex items-center justify-center text-black text-2xl font-semibold rounded-lg mb-1 overflow-hidden">
            <img
              src="https://twitter.com/tailwindcss/profile_image"
              alt="Profile image"
            />
          </div>
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center mb-3 px-4">
            ...
            <span className="text-white opacity-75">
              Adam Wathan <span className="text-gray-500 text-sm">(you)</span>
            </span>
          </div>
          <div className="flex items-center mb-3 px-4">
            <svg
